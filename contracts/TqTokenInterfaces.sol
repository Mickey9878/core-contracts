...
contract TqTokenStorage {
    ...
    /**
     * @notice Contract which oversees inter-tqToken operations
     */
    ...
    /**
     * @notice Initial exchange rate used when minting the first TqTokens (used when totalSupply = 0)
     */
...
contract TqTokenInterface is TqTokenStorage {
    /**
     * @notice Indicator that this is a TqToken contract (for inspection)
     */
     ...
     */
    event LiquidateBorrow(address liquidator, address borrower, uint repayAmount, address tqTokenCollateral, uint seizeTokens);
...
contract TqErc20Storage {
    /**
     * @notice Underlying asset for this TqToken
     */
